...
async def cmd_faq(message: Message):
	...
	text = (
		"❓ <b>С чего начать курс?</b>\n"
		"👉 Нажмите «Начать с первого урока»\n\n"
	
		"❓ <b>Как правильно проходить курс?</b>\n"
		"Рекомендация: 20–30 минут в день + выполнение практики.\n\n"
	
		"❓ <b>У меня не открывается видео</b>\n"
		"– обновите Telegram\n"
		"– проверьте интернет\n"
		"– перезапустите бота\n\n"
	
		"❓ <b>Можно ли смотреть с компьютера?</b>\n"
		"Да, Telegram Web или Desktop.\n\n"
	
		"❓ <b>Я случайно удалил бот — что делать?</b>\n"
		"Напишите в support @TataZakzheva\n"
		"или на email trgtart.office@gmail.com\n\n"
	
		"❓ <b>Я пропустил несколько дней — что делать?</b>\n"
		"Ничего страшного. Вернитесь к текущему уроку и продолжайте.\n\n"
	
		"❓ <b>Обязательно ли выполнять задания?</b>\n"
		"Да. Без практики курс остаётся теорией.\n\n"
	
		"❓ <b>Есть ли сообщество участников?</b>\n"
		"Напишите в поддержку для получения ссылки.\n\n"
	
		"❓ <b>Как попасть на коуч-сессию с Ицхаком?</b>\n"
		"Личные сессии проходят по предварительной заявке.\n\n"
	
		"❓ <b>Как получить доступ ко всем программам?</b>\n\n"
	
		"❓ <b>Можно ли вернуть деньги?</b>\n"
		"Напишите, пожалуйста, в сапорт @TataZakzheva"
	)
